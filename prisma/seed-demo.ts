...
async function main() {
  ...
  });
  {
    ...
    const ddl =
      "CREATE TABLE campaign_tracking (id INTEGER PRIMARY KEY AUTOINCREMENT, campaign TEXT NOT NULL, channel TEXT NOT NULL, spend_usd REAL NOT NULL DEFAULT 0, leads INTEGER NOT NULL DEFAULT 0, created_at TEXT NOT NULL);";
    const steps = [
